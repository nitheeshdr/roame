...
const sheetVariants = cva(
  'fixed z-50 flex flex-col gap-4 bg-card p-6 shadow-lg transition-transform',
  {
    variants: {
      side: {
        right: 'inset-y-0 right-0 h-full w-full border-l border-border sm:max-w-md data-[state=open]:animate-slide-in-right',
